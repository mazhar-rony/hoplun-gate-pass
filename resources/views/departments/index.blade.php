            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('departments.create') }}" class="btn btn-primary float-right">Add Department</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($departments as $department)
                                    <tr>
                                        ...
                                        <td>{!! $department->is_active ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>' !!}</td>
                                        <td>
                                            ...
                                            <form action="{{ route('departments.destroy', $department->id) }}" method="POST" onsubmit="return confirmDelete();" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
