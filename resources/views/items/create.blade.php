                    ...
                    <form action="{{ route('items.store') }}" method="post" class="form-horizontal">
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Item Name..." class="form-control">
                                    @error('name')
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><textarea name="description" id="description" rows="4" placeholder="About the item..." class="form-control"></textarea></div>
                                    @error('description')
                                        <span class="help-block text-danger">{{ $message }}</span>
                                    @enderror
                            </div>
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="uom" id="uom" class="form-control-sm form-control">
                                        ...
                                        @foreach ($unitOfMeasures as $unitOfMeasure)
                                            <option value="{{ $unitOfMeasure->value }}">{{ $unitOfMeasure->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <label for="checkbox1" class="form-check-label">
                                                <input type="checkbox" id="checkbox1" name="is_active" value="1" class="form-check-input" checked> Active
                                            </label>
                                        </div>
                                    </div>
                                </div>
