            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('items.create') }}" class="btn btn-primary float-right">Add Item</a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('items.destroy', $item->id) }}" method="POST" onsubmit="return confirmDelete();" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
