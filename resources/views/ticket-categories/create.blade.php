...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="row d-flex align-items-center justify-content-center mt-5">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ route('ticket-categories.store') }}" method="post" class="form-horizontal">
                        @csrf
                        <div class="card-header" style="height: 65px">
                            <strong>Add Ticket Category</strong>
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="name" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Category Name..." class="form-control">
