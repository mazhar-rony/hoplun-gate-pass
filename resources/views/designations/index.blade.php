                            ...
                            <tbody>
                                @foreach ($designations as $designation)
                                    <tr>
                                        ...
                                        <td>{!! $designation->is_active ? '<span class="badge badge-success">Active</span>' : '<span class="badge badge-danger">Inactive</span>' !!}</td>
                                        <td>
                                            {{-- <a href="{{ route('designations.show', $designation->id) }}" class="btn btn-info btn-sm">View</a> --}}
                                            <a href="{{ route('designations.edit', $designation->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                            <form action="{{ route('designations.destroy', $designation->id) }}" method="POST" onsubmit="return confirmDelete();" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
